...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        public Matrix2x2(TrueSync.FP m11, TrueSync.FP m12, TrueSync.FP m21, TrueSync.FP m22)
        {
            M11 = m11;
            M12 = m12;
            M21 = m21;
        ...
        public static void CreateScale(TrueSync.FP scale, out Matrix2x2 matrix)
        {
            matrix.M11 = scale;
            matrix.M22 = scale;
        ...
        {
            TrueSync.FP determinantInverse = F64.C1 / (matrix.M11 * matrix.M22 - matrix.M12 * matrix.M21);
            TrueSync.FP m11 = matrix.M22 * determinantInverse;
            TrueSync.FP m12 = -matrix.M12 * determinantInverse;

            TrueSync.FP m21 = -matrix.M21 * determinantInverse;
            TrueSync.FP m22 = matrix.M11 * determinantInverse;
        ...
        {
            TrueSync.FP resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            TrueSync.FP resultM12 = a.M11 * b.M12 + a.M12 * b.M22;

            TrueSync.FP resultM21 = a.M21 * b.M11 + a.M22 * b.M21;
            TrueSync.FP resultM22 = a.M21 * b.M12 + a.M22 * b.M22;
        ...
        {
            TrueSync.FP m11 = -matrix.M11;
            TrueSync.FP m12 = -matrix.M12;

            TrueSync.FP m21 = -matrix.M21;
            TrueSync.FP m22 = -matrix.M22;
