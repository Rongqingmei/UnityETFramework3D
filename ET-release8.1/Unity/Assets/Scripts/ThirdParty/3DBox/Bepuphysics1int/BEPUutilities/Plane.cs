...
namespace BEPUutilities
{
    ...
    public struct Plane
    {
        ...
        public Plane(Vector3 normal, TrueSync.FP d)
            : this(ref normal, d)
        {
        }
        ...
        /// <param name="normal">Normal of the plane.</param>
        /// <param name="d">Negative distance to the plane from the origin along the normal.</param>
        public Plane(ref Vector3 normal, TrueSync.FP d)
        {
            this.Normal = normal;
            this.D = d;
        }
        ...
        public void DotCoordinate(ref Vector3 v, out TrueSync.FP dot)
        {
