...
namespace BEPUutilities.ResourceManagement
{
    ...
    public static class CommonResources
    {
        ...
        public static void ResetPools()
        {
            ...
            SubPoolFloatList = new LockingResourcePool<RawList<TrueSync.FP>>();
        ...
        static LockingResourcePool<RawList<TrueSync.FP>> SubPoolFloatList;
        ...
        public static RawList<TrueSync.FP> GetFloatList()
        {
        ...
        /// </summary>
        /// <param name="list">List to return.</param>
        public static void GiveBack(RawList<TrueSync.FP> list)
        {
            list.Clear();
