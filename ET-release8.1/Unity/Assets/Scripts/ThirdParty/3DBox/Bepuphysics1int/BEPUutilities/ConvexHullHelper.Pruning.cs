...
namespace BEPUutilities
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<Vector3> points, TrueSync.FP cellSize)
        {
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<Vector3> points, TrueSync.FP cellSize)
        {
            ...
            for (int i = points.Count - 1; i >= 0; --i)
            {
                ...
                {
                    X = (int)TrueSync.FP.Floor(element.X / cellSize),
                    Y = (int)TrueSync.FP.Floor(element.Y / cellSize),
                    Z = (int)TrueSync.FP.Floor(element.Z / cellSize) 
                };
