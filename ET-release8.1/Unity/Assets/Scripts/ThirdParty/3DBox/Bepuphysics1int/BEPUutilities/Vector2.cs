...
namespace BEPUutilities
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public Vector2(TrueSync.FP x, TrueSync.FP y)
        {
            this.X = x;
            this.Y = y;
        }
        ...
        {
            return TrueSync.FP.Sqrt(X * X + Y * Y);
        }
        ...
        public static void Multiply(ref Vector2 v, TrueSync.FP scale, out Vector2 result)
        {
            result.X = v.X * scale;
            result.Y = v.Y * scale;
        }
        ...
        public static void Divide(ref Vector2 v, TrueSync.FP divisor, out Vector2 result)
        {
            TrueSync.FP inverse = F64.C1 / divisor;
        ...
        public static void Dot(ref Vector2 a, ref Vector2 b, out TrueSync.FP dot)
        {
            dot = a.X * b.X + a.Y * b.Y;
        }
        ...
        public static TrueSync.FP Dot(Vector2 a, Vector2 b)
        {
        ...
        {
            TrueSync.FP inverse = F64.C1 / TrueSync.FP.Sqrt(v.X * v.X + v.Y * v.Y);
            result.X = v.X * inverse;
            result.Y = v.Y * inverse;
        }
        ...
        {
            TrueSync.FP inverse = F64.C1 / TrueSync.FP.Sqrt(X * X + Y * Y);
            X *= inverse;
            Y *= inverse;
        }
        ...
        public static Vector2 operator *(Vector2 v, TrueSync.FP f)
        {
            Vector2 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        /// <param name="f">Amount to scale.</param>
        /// <returns>Scaled vector.</returns>
        public static Vector2 operator *(TrueSync.FP f, Vector2 v)
        {
            Vector2 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
