...
namespace BEPUutilities
{
    ...
    public struct Matrix3x3
    {
        ...
        /// </summary>
        public TrueSync.FP M11;

        /// <summary>
        /// Value at row 1, column 2 of the matrix.
        /// </summary>
        public TrueSync.FP M12;

        /// <summary>
        /// Value at row 1, column 3 of the matrix.
        /// </summary>
        public TrueSync.FP M13;

        /// <summary>
        /// Value at row 2, column 1 of the matrix.
        /// </summary>
        public TrueSync.FP M21;

        /// <summary>
        /// Value at row 2, column 2 of the matrix.
        /// </summary>
        public TrueSync.FP M22;

        /// <summary>
        /// Value at row 2, column 3 of the matrix.
        /// </summary>
        public TrueSync.FP M23;

        /// <summary>
        /// Value at row 3, column 1 of the matrix.
        /// </summary>
        public TrueSync.FP M31;

        /// <summary>
        /// Value at row 3, column 2 of the matrix.
        /// </summary>
        public TrueSync.FP M32;

        /// <summary>
        /// Value at row 3, column 3 of the matrix.
        /// </summary>
        public TrueSync.FP M33;
        ...
        public Matrix3x3(TrueSync.FP m11, TrueSync.FP m12, TrueSync.FP m13, TrueSync.FP m21, TrueSync.FP m22, TrueSync.FP m23, TrueSync.FP m31, TrueSync.FP m32, TrueSync.FP m33)
        {
            M11 = m11;
            M12 = m12;
            M13 = m13;
        ...
        {
            TrueSync.FP m11 = a.M11 + b.M11;
            TrueSync.FP m12 = a.M12 + b.M12;
            TrueSync.FP m13 = a.M13 + b.M13;

            TrueSync.FP m21 = a.M21 + b.M21;
            TrueSync.FP m22 = a.M22 + b.M22;
            TrueSync.FP m23 = a.M23 + b.M23;

            TrueSync.FP m31 = a.M31 + b.M31;
            TrueSync.FP m32 = a.M32 + b.M32;
            TrueSync.FP m33 = a.M33 + b.M33;
        ...
        public static void CreateScale(TrueSync.FP scale, out Matrix3x3 matrix)
        {
        ...
        public static Matrix3x3 CreateScale(TrueSync.FP scale)
        {
        ...
        /// <param name="matrix">Scaling matrix.</param>
        public static void CreateScale(TrueSync.FP x, TrueSync.FP y, TrueSync.FP z, out Matrix3x3 matrix)
        {
        ...
        /// <param name="z">Scaling along the z axis.</param>
        /// <returns>Scaling matrix.</returns>
        public static Matrix3x3 CreateScale(TrueSync.FP x, TrueSync.FP y, TrueSync.FP z)
        {
        ...
        public static void AdaptiveInvert(ref Matrix3x3 matrix, out Matrix3x3 result)
        {
			...
			int submatrix;
            TrueSync.FP determinantInverse = F64.C1 / matrix.AdaptiveDeterminant(out submatrix);
            TrueSync.FP m11, m12, m13, m21, m22, m23, m31, m32, m33;
            switch (submatrix)
            {
        ...
        public static void AdjugateTranspose(ref Matrix3x3 matrix, out Matrix3x3 result)
        {
            ...
            TrueSync.FP m11 = (matrix.M22 * matrix.M33 - matrix.M23 * matrix.M32);
            TrueSync.FP m12 = (matrix.M13 * matrix.M32 - matrix.M33 * matrix.M12);
            TrueSync.FP m13 = (matrix.M12 * matrix.M23 - matrix.M22 * matrix.M13);

            TrueSync.FP m21 = (matrix.M23 * matrix.M31 - matrix.M21 * matrix.M33);
            TrueSync.FP m22 = (matrix.M11 * matrix.M33 - matrix.M13 * matrix.M31);
            TrueSync.FP m23 = (matrix.M13 * matrix.M21 - matrix.M11 * matrix.M23);

            TrueSync.FP m31 = (matrix.M21 * matrix.M32 - matrix.M22 * matrix.M31);
            TrueSync.FP m32 = (matrix.M12 * matrix.M31 - matrix.M11 * matrix.M32);
            TrueSync.FP m33 = (matrix.M11 * matrix.M22 - matrix.M12 * matrix.M21);
        ...
        /// <returns>Product of the multiplication.</returns>
        public static Matrix3x3 operator *(Matrix3x3 m, TrueSync.FP f)
        {
            Matrix3x3 result;
        ...
        /// <param name="f">Scaling value to apply to all components of the matrix.</param>
        /// <returns>Product of the multiplication.</returns>
        public static Matrix3x3 operator *(TrueSync.FP f, Matrix3x3 m)
        {
            Matrix3x3 result;
            Multiply(ref m, f, out result);
            return result;
        ...
        {
            TrueSync.FP resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            TrueSync.FP resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            TrueSync.FP resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;

            TrueSync.FP resultM21 = a.M21 * b.M11 + a.M22 * b.M21 + a.M23 * b.M31;
            TrueSync.FP resultM22 = a.M21 * b.M12 + a.M22 * b.M22 + a.M23 * b.M32;
            TrueSync.FP resultM23 = a.M21 * b.M13 + a.M22 * b.M23 + a.M23 * b.M33;

            TrueSync.FP resultM31 = a.M31 * b.M11 + a.M32 * b.M21 + a.M33 * b.M31;
            TrueSync.FP resultM32 = a.M31 * b.M12 + a.M32 * b.M22 + a.M33 * b.M32;
            TrueSync.FP resultM33 = a.M31 * b.M13 + a.M32 * b.M23 + a.M33 * b.M33;
        ...
        {
            TrueSync.FP resultM11 = transpose.M11 * matrix.M11 + transpose.M21 * matrix.M21 + transpose.M31 * matrix.M31;
            TrueSync.FP resultM12 = transpose.M11 * matrix.M12 + transpose.M21 * matrix.M22 + transpose.M31 * matrix.M32;
            TrueSync.FP resultM13 = transpose.M11 * matrix.M13 + transpose.M21 * matrix.M23 + transpose.M31 * matrix.M33;

            TrueSync.FP resultM21 = transpose.M12 * matrix.M11 + transpose.M22 * matrix.M21 + transpose.M32 * matrix.M31;
            TrueSync.FP resultM22 = transpose.M12 * matrix.M12 + transpose.M22 * matrix.M22 + transpose.M32 * matrix.M32;
            TrueSync.FP resultM23 = transpose.M12 * matrix.M13 + transpose.M22 * matrix.M23 + transpose.M32 * matrix.M33;

            TrueSync.FP resultM31 = transpose.M13 * matrix.M11 + transpose.M23 * matrix.M21 + transpose.M33 * matrix.M31;
            TrueSync.FP resultM32 = transpose.M13 * matrix.M12 + transpose.M23 * matrix.M22 + transpose.M33 * matrix.M32;
            TrueSync.FP resultM33 = transpose.M13 * matrix.M13 + transpose.M23 * matrix.M23 + transpose.M33 * matrix.M33;
        ...
        {
            TrueSync.FP resultM11 = matrix.M11 * transpose.M11 + matrix.M12 * transpose.M12 + matrix.M13 * transpose.M13;
            TrueSync.FP resultM12 = matrix.M11 * transpose.M21 + matrix.M12 * transpose.M22 + matrix.M13 * transpose.M23;
            TrueSync.FP resultM13 = matrix.M11 * transpose.M31 + matrix.M12 * transpose.M32 + matrix.M13 * transpose.M33;

            TrueSync.FP resultM21 = matrix.M21 * transpose.M11 + matrix.M22 * transpose.M12 + matrix.M23 * transpose.M13;
            TrueSync.FP resultM22 = matrix.M21 * transpose.M21 + matrix.M22 * transpose.M22 + matrix.M23 * transpose.M23;
            TrueSync.FP resultM23 = matrix.M21 * transpose.M31 + matrix.M22 * transpose.M32 + matrix.M23 * transpose.M33;

            TrueSync.FP resultM31 = matrix.M31 * transpose.M11 + matrix.M32 * transpose.M12 + matrix.M33 * transpose.M13;
            TrueSync.FP resultM32 = matrix.M31 * transpose.M21 + matrix.M32 * transpose.M22 + matrix.M33 * transpose.M23;
            TrueSync.FP resultM33 = matrix.M31 * transpose.M31 + matrix.M32 * transpose.M32 + matrix.M33 * transpose.M33;
        ...
        public static void Multiply(ref Matrix3x3 matrix, TrueSync.FP scale, out Matrix3x3 result)
        {
        ...
        {
            TrueSync.FP m21 = matrix.M12;
            TrueSync.FP m31 = matrix.M13;
            TrueSync.FP m12 = matrix.M21;
            TrueSync.FP m32 = matrix.M23;
            TrueSync.FP m13 = matrix.M31;
            TrueSync.FP m23 = matrix.M32;
        ...
        internal TrueSync.FP AdaptiveDeterminant(out int subMatrixCode)
        {
            ...
            //Try m11, m12, m21, m22.
            TrueSync.FP determinant = M11 * M22 - M12 * M21;
        ...
        {
            TrueSync.FP qX2 = quaternion.X + quaternion.X;
            TrueSync.FP qY2 = quaternion.Y + quaternion.Y;
            TrueSync.FP qZ2 = quaternion.Z + quaternion.Z;
            TrueSync.FP XX = qX2 * quaternion.X;
            TrueSync.FP YY = qY2 * quaternion.Y;
            TrueSync.FP ZZ = qZ2 * quaternion.Z;
            TrueSync.FP XY = qX2 * quaternion.Y;
            TrueSync.FP XZ = qX2 * quaternion.Z;
            TrueSync.FP XW = qX2 * quaternion.W;
            TrueSync.FP YZ = qY2 * quaternion.Z;
            TrueSync.FP YW = qY2 * quaternion.W;
            TrueSync.FP ZW = qZ2 * quaternion.W;
        ...
        public static Matrix3x3 CreateFromAxisAngle(Vector3 axis, TrueSync.FP angle)
        {
            Matrix3x3 toReturn;
        ...
        public static void CreateFromAxisAngle(ref Vector3 axis, TrueSync.FP angle, out Matrix3x3 result)
        {
            TrueSync.FP xx = axis.X * axis.X;
            TrueSync.FP yy = axis.Y * axis.Y;
            TrueSync.FP zz = axis.Z * axis.Z;
            TrueSync.FP xy = axis.X * axis.Y;
            TrueSync.FP xz = axis.X * axis.Z;
            TrueSync.FP yz = axis.Y * axis.Z;

            TrueSync.FP sinAngle = TrueSync.FP.Sin(angle);
            TrueSync.FP oneMinusCosAngle = F64.C1 - TrueSync.FP.Cos(angle);
