...
namespace BEPUutilities
{
    ...
    public struct Matrix
    {
        ...
        /// </summary>
        public TrueSync.FP M34;

        /// <summary>
        /// Value at row 4, column 1 of the matrix.
        /// </summary>
        public TrueSync.FP M41;

        /// <summary>
        /// Value at row 4, column 2 of the matrix.
        /// </summary>
        public TrueSync.FP M42;

        /// <summary>
        /// Value at row 4, column 3 of the matrix.
        /// </summary>
        public TrueSync.FP M43;

        /// <summary>
        /// Value at row 4, column 4 of the matrix.
        /// </summary>
        public TrueSync.FP M44;
        ...
        public Matrix(TrueSync.FP m11, TrueSync.FP m12, TrueSync.FP m13, TrueSync.FP m14,
                      TrueSync.FP m21, TrueSync.FP m22, TrueSync.FP m23, TrueSync.FP m24,
                      TrueSync.FP m31, TrueSync.FP m32, TrueSync.FP m33, TrueSync.FP m34,
                      TrueSync.FP m41, TrueSync.FP m42, TrueSync.FP m43, TrueSync.FP m44)
        {
            this.M11 = m11;
            this.M12 = m12;
            this.M13 = m13;
        ...
        /// </summary>
        /// <returns></returns>
        public TrueSync.FP Determinant()
        {
            //Compute the re-used 2x2 determinants.
            TrueSync.FP det1 = M33 * M44 - M34 * M43;
            TrueSync.FP det2 = M32 * M44 - M34 * M42;
            TrueSync.FP det3 = M32 * M43 - M33 * M42;
            TrueSync.FP det4 = M31 * M44 - M34 * M41;
            TrueSync.FP det5 = M31 * M43 - M33 * M41;
            TrueSync.FP det6 = M31 * M42 - M32 * M41;
            return
        ...
        public static Matrix CreateFromAxisAngle(Vector3 axis, TrueSync.FP angle)
        {
            Matrix toReturn;
        ...
        public static void CreateFromAxisAngle(ref Vector3 axis, TrueSync.FP angle, out Matrix result)
        {
        ...
        {
            TrueSync.FP resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31 + a.M14 * b.M41;
            TrueSync.FP resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32 + a.M14 * b.M42;
            TrueSync.FP resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33 + a.M14 * b.M43;
            TrueSync.FP resultM14 = a.M11 * b.M14 + a.M12 * b.M24 + a.M13 * b.M34 + a.M14 * b.M44;

            TrueSync.FP resultM21 = a.M21 * b.M11 + a.M22 * b.M21 + a.M23 * b.M31 + a.M24 * b.M41;
            TrueSync.FP resultM22 = a.M21 * b.M12 + a.M22 * b.M22 + a.M23 * b.M32 + a.M24 * b.M42;
            TrueSync.FP resultM23 = a.M21 * b.M13 + a.M22 * b.M23 + a.M23 * b.M33 + a.M24 * b.M43;
            TrueSync.FP resultM24 = a.M21 * b.M14 + a.M22 * b.M24 + a.M23 * b.M34 + a.M24 * b.M44;

            TrueSync.FP resultM31 = a.M31 * b.M11 + a.M32 * b.M21 + a.M33 * b.M31 + a.M34 * b.M41;
            TrueSync.FP resultM32 = a.M31 * b.M12 + a.M32 * b.M22 + a.M33 * b.M32 + a.M34 * b.M42;
            TrueSync.FP resultM33 = a.M31 * b.M13 + a.M32 * b.M23 + a.M33 * b.M33 + a.M34 * b.M43;
            TrueSync.FP resultM34 = a.M31 * b.M14 + a.M32 * b.M24 + a.M33 * b.M34 + a.M34 * b.M44;

            TrueSync.FP resultM41 = a.M41 * b.M11 + a.M42 * b.M21 + a.M43 * b.M31 + a.M44 * b.M41;
            TrueSync.FP resultM42 = a.M41 * b.M12 + a.M42 * b.M22 + a.M43 * b.M32 + a.M44 * b.M42;
            TrueSync.FP resultM43 = a.M41 * b.M13 + a.M42 * b.M23 + a.M43 * b.M33 + a.M44 * b.M43;
            TrueSync.FP resultM44 = a.M41 * b.M14 + a.M42 * b.M24 + a.M43 * b.M34 + a.M44 * b.M44;
        ...
        public static void Multiply(ref Matrix matrix, TrueSync.FP scale, out Matrix result)
        {
        ...
        public static Matrix operator *(Matrix m, TrueSync.FP f)
        {
            Matrix result;
        ...
        /// <param name="f">Scaling value to apply to all components of the matrix.</param>
        /// <returns>Product of the multiplication.</returns>
        public static Matrix operator *(TrueSync.FP f, Matrix m)
        {
            Matrix result;
            Multiply(ref m, f, out result);
            return result;
        ...
        {
            TrueSync.FP intermediate = m.M12;
        ...
        public static void CreateOrthographicRH(TrueSync.FP left, TrueSync.FP right, TrueSync.FP bottom, TrueSync.FP top, TrueSync.FP zNear, TrueSync.FP zFar, out Matrix projection)
        {
            TrueSync.FP width = right - left;
            TrueSync.FP height = top - bottom;
            TrueSync.FP depth = zFar - zNear;
        ...
        public static void CreatePerspectiveFieldOfViewRH(TrueSync.FP fieldOfView, TrueSync.FP aspectRatio, TrueSync.FP nearClip, TrueSync.FP farClip, out Matrix perspective)
        {
            TrueSync.FP h = F64.C1 / TrueSync.FP.Tan(fieldOfView / F64.C2);
            TrueSync.FP w = h / aspectRatio;
            perspective.M11 = w;
        ...
        public static Matrix CreatePerspectiveFieldOfViewRH(TrueSync.FP fieldOfView, TrueSync.FP aspectRatio, TrueSync.FP nearClip, TrueSync.FP farClip)
        {
            Matrix perspective;
        ...
        {
            Vector3 z;
            TrueSync.FP length = forward.Length();
        ...
        /// <param name="scaleMatrix">Matrix representing the given scale.</param>
        public static void CreateScale(TrueSync.FP x, TrueSync.FP y, TrueSync.FP z, out Matrix scaleMatrix)
        {
            scaleMatrix = new Matrix
            {
                M11 = x,
        ...
        /// <param name="z">Scale along the z axis.</param>
        /// <returns>Matrix representing the given scale.</returns>
        public static Matrix CreateScale(TrueSync.FP x, TrueSync.FP y, TrueSync.FP z)
        {
            Matrix scaleMatrix;
