...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class BoxShape : ConvexShape
    {
        ...
        public override bool RayTest(ref Ray ray, ref RigidTransform transform, Fix64 maximumLength, out RayHit hit)
        {
            ...
            Fix64 t1 = Fix64.OverflowMul((-halfWidth - localOrigin.X), inverseDirection);
            Fix64 t2 = Fix64.OverflowMul((halfWidth - localOrigin.X), inverseDirection);
            ...
            t1 = Fix64.OverflowMul((-halfHeight - localOrigin.Y), inverseDirection);
            t2 = Fix64.OverflowMul((halfHeight - localOrigin.Y), inverseDirection);
            ...
            t1 = Fix64.OverflowMul((-halfLength - localOrigin.Z), inverseDirection);
            t2 = Fix64.OverflowMul((halfLength - localOrigin.Z), inverseDirection);
