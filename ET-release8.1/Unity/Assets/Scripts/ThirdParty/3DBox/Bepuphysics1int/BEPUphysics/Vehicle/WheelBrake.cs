...
namespace BEPUphysics.Vehicle
{
    ...
    public class WheelBrake : ISolverSettings
    {
        ...
        private TrueSync.FP angularAX, angularAY, angularAZ;
        private TrueSync.FP angularBX, angularBY, angularBZ;
        internal bool isActive = true;
        private TrueSync.FP linearAX, linearAY, linearAZ;
        private TrueSync.FP blendedCoefficient;
        private TrueSync.FP kineticBrakingFrictionCoefficient;
        private WheelFrictionBlender frictionBlender = DefaultRollingFrictionBlender;
        private bool isBraking;
        private TrueSync.FP rollingFrictionCoefficient;
        internal SolverSettings solverSettings = new SolverSettings();
        private TrueSync.FP staticBrakingFrictionCoefficient;
        private TrueSync.FP staticFrictionVelocityThreshold = F64.C5;
        private Wheel wheel;
        internal int numIterationsAtZeroImpulse;
        private Entity vehicleEntity, supportEntity;

        //Inverse effective mass matrix
        private TrueSync.FP velocityToImpulse;
        ...
        public WheelBrake(TrueSync.FP dynamicBrakingFrictionCoefficient, TrueSync.FP staticBrakingFrictionCoefficient, TrueSync.FP rollingFrictionCoefficient)
        {
        ...
        /// isBraking is true.
        /// </summary>
        public TrueSync.FP KineticBrakingFrictionCoefficient
        {
        ...
        /// isBraking is false.
        /// </summary>
        public TrueSync.FP RollingFrictionCoefficient
        {
        ...
        /// isBraking is true.
        /// </summary>
        public TrueSync.FP StaticBrakingFrictionCoefficient
        {
        ...
        /// </summary>
        public TrueSync.FP StaticFrictionVelocityThreshold
        {
            get { return staticFrictionVelocityThreshold; }
            set { staticFrictionVelocityThreshold = TrueSync.FP.Abs(value); }
        }
        ...
        public TrueSync.FP RelativeVelocity
        {
            get
            {
                TrueSync.FP velocity = vehicleEntity.linearVelocity.X * linearAX + vehicleEntity.linearVelocity.Y * linearAY + vehicleEntity.linearVelocity.Z * linearAZ +
        ...
        internal TrueSync.FP ApplyImpulse()
        {
            ...
            TrueSync.FP lambda = RelativeVelocity * velocityToImpulse;


            //Clamp accumulated impulse
            TrueSync.FP previousAccumulatedImpulse = accumulatedImpulse;
            TrueSync.FP maxForce = -blendedCoefficient * wheel.suspension.accumulatedImpulse;
        ...
        internal void PreStep(TrueSync.FP dt)
        {
            ...
            if (isBraking)
                if (TrueSync.FP.Abs(RelativeVelocity) < staticFrictionVelocityThreshold)
