...
namespace BEPUphysics.Vehicle
{
    ...
    public class WheelSlidingFriction : ISolverSettings
    {
        ...
        private TrueSync.FP kineticCoefficient;
        ...
        private TrueSync.FP staticCoefficient;
        ...
        public WheelSlidingFriction(TrueSync.FP dynamicCoefficient, TrueSync.FP staticCoefficient)
        {
        ...
        /// </summary>
        public TrueSync.FP KineticCoefficient
        {
        ...
        /// taken into account to determine the used coefficient at any given time.
        /// </summary>
        public TrueSync.FP StaticCoefficient
        {
        ...
        internal void PreStep(TrueSync.FP dt)
        {
            ...
            TrueSync.FP axisLength = slidingFrictionAxis.LengthSquared();
