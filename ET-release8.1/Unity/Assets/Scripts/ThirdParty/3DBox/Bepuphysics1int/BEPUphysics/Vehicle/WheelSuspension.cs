...
namespace BEPUphysics.Vehicle
{
    ...
    public class WheelSuspension : ISpringSettings, ISolverSettings
    {
        ...
        private TrueSync.FP bias;

        internal bool isActive = true;
        private TrueSync.FP linearAX, linearAY, linearAZ;
        private TrueSync.FP allowedCompression = (TrueSync.FP).01m;
        internal TrueSync.FP currentLength;
        internal Vector3 localAttachmentPoint;
        internal Vector3 localDirection;
        private TrueSync.FP maximumSpringCorrectionSpeed = TrueSync.FP.MaxValue;
        private TrueSync.FP maximumSpringForce = TrueSync.FP.MaxValue;
        internal TrueSync.FP restLength;
        ...
        public WheelSuspension(TrueSync.FP stiffnessConstant, TrueSync.FP dampingConstant, Vector3 localDirection, TrueSync.FP restLength, Vector3 localAttachmentPoint)
        {
        ...
        /// </summary>
        public TrueSync.FP AllowedCompression
        {
        ...
        /// </summary>
        public TrueSync.FP CurrentLength
        {
        ...
        /// </summary>
        public TrueSync.FP MaximumSpringCorrectionSpeed
        {
        ...
        /// </summary>
        public TrueSync.FP MaximumSpringForce
        {
