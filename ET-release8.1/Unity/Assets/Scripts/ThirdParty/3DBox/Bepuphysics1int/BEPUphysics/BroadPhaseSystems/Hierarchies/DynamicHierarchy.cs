...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    ...
    public class DynamicHierarchy : BroadPhase
    {
        ...
        public override void Add(BroadPhaseEntry entry)
        {
            ...
            if (Fix64.OverflowMul(Fix64.OverflowMul(offset.X, offset.Y), offset.Z) == F64.C0)
            ...
            else
            {
                ...
                else
                {
                    ...
                    internalNode.currentVolume = Fix64.OverflowMul(Fix64.OverflowMul(offset.X, offset.Y), offset.Z);
        ...
        public Fix64 MeasureCostMetric()
        {
            if (root != null)
            {
                ...
                var volume = Fix64.OverflowMul(Fix64.OverflowMul(offset.X, offset.Y), offset.Z);
                if (volume < F64.C1em9)
                    return F64.C0;
