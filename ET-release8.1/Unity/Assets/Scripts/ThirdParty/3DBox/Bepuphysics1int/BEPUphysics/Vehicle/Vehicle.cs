...
namespace BEPUphysics.Vehicle
{
    ...
    public class Vehicle : CombinedUpdateable, IDuringForcesUpdateable, IBeforeNarrowPhaseUpdateable, IEndOfTimeStepUpdateable, IEndOfFrameUpdateable
    {
        ...
        void IEndOfFrameUpdateable.Update(TrueSync.FP dt)
        {
        ...
        /// </summary>
        /// <param name="dt">Time since last frame in simulation seconds.</param>
        void IEndOfTimeStepUpdateable.Update(TrueSync.FP dt)
        {
            //Graphics should be updated at the end of each frame.
            foreach (Wheel wheel in Wheels)
            {
        ...
        void IBeforeNarrowPhaseUpdateable.Update(TrueSync.FP dt)
        {
        ...
        void IDuringForcesUpdateable.Update(TrueSync.FP dt)
        {
            foreach (Wheel wheel in wheels)
            {
        ...
        /// </summary>
        public override TrueSync.FP SolveIteration()
        {
            int numActive = 0;
            foreach (Wheel wheel in Wheels)
            {
        ...
        public override void Update(TrueSync.FP dt)
        {
